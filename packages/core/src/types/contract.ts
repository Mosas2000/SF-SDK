/**
 * Contract-level TypeScript types
 * 
 * These types represent raw on-chain data shapes returned
...
/**
 * Data received when a transaction finishes.
 */
...
/**
 * Callbacks passed to contract write functions.
 */
...
/**
 * Known Clarity error codes from smart contracts.
